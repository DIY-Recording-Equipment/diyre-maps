...
//------------------------------------------------------------FUNCTS
    ...
    var updateBar     = function(){
      ...
      if(youWin == true && barCycle % 4 == 0){
        ...
        // console.log(temp);
        document.getElementById("myBar").transition = "background-color 0.4s linear";
        winButton.style.backgroundColor = temp;
        document.getElementById("myBar").style.backgroundColor = temp;
      };
